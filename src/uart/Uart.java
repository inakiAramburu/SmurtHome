...
public class Uart {
	...
	public Uart(Preset oraingoa) {
		 this.preset=oraingoa;
	...
	public void enviar(Preset preset) {
		...
		datos[0] = this.preset.getTemperatura();

		datos[1] = this.preset.getIntensidad();

		datos[2] = this.preset.getPersiana();

		datos[3] = this.preset.getAutomatico();
